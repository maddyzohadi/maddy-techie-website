...
export default async function Hero() {
  ...
  const stats = [
    { value: '4',    label: t('statModules'),  color: '#5B9CF8' },
    { value: '12+',  label: t('statProjects'), color: '#8B5CF6' },
    { value: '0',    label: t('statCode'),     color: '#5B9CF8' },
    { value: '100%', label: t('statPractical'),color: '#FF7555' },
  ]
  ...
  return (
    ...
    >
      ...
      >
        <div className="card-glass px-4 py-3 flex items-center gap-3 w-48" style={{ borderColor: 'rgba(91,156,248,0.15)' }}>
        ...
        <div className="card-glass px-4 py-3 flex items-center gap-3 w-48 ml-6" style={{ borderColor: 'rgba(139,92,246,0.15)' }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        ...
        <div className="flex justify-center mb-8">
          <span
            ...
            style={{ background: 'rgba(91,156,248,0.10)', border: '1px solid rgba(91,156,248,0.22)', color: '#5B9CF8' }}
          >
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5">
            {tools.map((tool) => (
              <span
                ...
                style={{ background: tool.color, border: `1px solid ${tool.border}`, color: '#8A97A8' }}
              >
                {tool.label}
              </span>
            ))}
        ...
        <div className="mt-12 flex justify-center">
          <div
            ...
            style={{ background: 'rgba(255,117,85,0.10)', border: '1px solid rgba(255,117,85,0.20)' }}
          >
