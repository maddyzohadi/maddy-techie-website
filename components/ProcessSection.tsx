...
const FA_STEPS = [
  { week: 'هفته ۱', title: 'آشنایی با نیاز',    desc: 'با هم بررسی میکنیم چی لازم داری و کجا وقت هدر میره' },
  { week: 'هفته ۲', title: 'طراحی سیستم',       desc: 'یه نقشه راه ساده و اجرایی برات میسازیم' },
  { week: 'هفته ۳', title: 'اجرا و آموزش',      desc: 'سیستم رو راه میندازیم و یاد میگیری چطور ازش استفاده کنی' },
  { week: 'هفته ۴', title: 'تحویل و پشتیبانی', desc: 'همه چیز آماده‌ست، تو فقط کار میکنی' },
]
